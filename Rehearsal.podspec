...
Pod::Spec.new do |s|
  s.name             = 'Rehearsal'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Rehearsal.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/fuwenhua/Rehearsal'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'fuwenhua' => 'shizhou@live.com' }
  s.source           = { :git => 'https://github.com/fuwenhua/Rehearsal.git', :tag => s.version.to_s }
